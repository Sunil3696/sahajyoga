...
export function HomeFooter() {
   let [chakra, setChakra] = useState();
   let [nadis, setNadis] = useState();
   let [kundalini, setKundalini] = useState();
...
let params = useParams();
   useEffect(() => {
      ...
      getItems('systems/fe')
         .then((response) => {
            let options = response.result?.filter((obj) => obj?.under_head == "62ad9ca32c0d9d99d350db54")
            setNadis(options)
         })

         getItems('systems/fe')
         .then((response) => {
            let options = response.result?.filter((obj) => obj?.under_head == "62ad9cb32c0d9d99d350db57")
            setKundalini (options)
         })
   }, [params])
   ...
   return (
      <>
         <footer className="bg-white pt-20 lg:pt-[120px] pb-10 lg:pb-20 relative z-10" data-aos="fade-up">
            <div className="">
               <div className="flex flex-wrap mx-10">
                  <div className="w-full sm:w-2/3 lg:w-3/12 px-4">
                     <div className=" mb-10">
                        ...
                        <span className="text-base text-gray-500 mb-7">
                           <span className="font-bold text-indigo-600">Sahaja Yoga</span> is a unique method of meditation based on an experience known as Self Realisation which was discovered by H.H. Shri Mataji Nirmala Devi in 1970
                        </span>
                        <p className="flex items-center text-sm text-dark font-medium mt-10">
                           ...
                           <span>+977 (9841) 2708 15</span>
                        </p>
                     </div>
                  </div>
                  <div className="w-full sm:w-1/2 lg:w-2/12 px-4">
                     <div className="w-full mb-10">
                        <h4 className="text-dark text-lg font-semibold mb-9 text-indigo-600 font-bold">CHAKRAS</h4>
                        <ul>
                  ...
                  <div className="w-full sm:w-1/2 lg:w-2/12 px-4">
                     <div className="w-full mb-10">
                        <h4 className="text-dark text-lg font-semibold mb-9 text-indigo-600 font-bold">NADIS</h4>
                        <ul>
                        {
                              nadis ?
                                 nadis.map((o, index) => (
                  ...
                  <div className="w-full sm:w-1/2 lg:w-2/12 px-4">
                     <div className="w-full mb-10">
                        <h4 className="text-dark text-lg font-semibold mb-9 text-indigo-600 font-bold">KUNDALINI</h4>
                        <ul>
                        {
                              kundalini ?
                                 kundalini.map((o, index) => (
                                    <li key={index} className="inline-block
                                    text-base text-body-color
                                    hover:text-indigo-600
                                    text-gray-500
                  ...
                  <div className="w-full sm:w-1/2 lg:w-3/12 px-4">
                     <div className="w-full mb-10">
                        <h4 className="text-dark text-lg font-semibold mb-9 text-indigo-600 font-bold">Follow Us On</h4>
                    ...
                    text-gray-600
                    hover:text-indigo-700 hover:bg-white hover:border-indigo-500
                    mr-3
                    sm:mr-4
                    lg:mr-3
                    xl:mr-4
                    ...
                    "
                        ...
                        <p className="text-base text-gray-600">&copy; <span id="date">{year}</span> Sahaja Yoga Nepal</p>
                     </div>
                  </div>
               </div>
            </div>
